...
const edges: DeityEdge[] = [
  ...
  { id: 'e95', from: 'vayu', to: 'hanuman', type: 'teacher_of', label: 'divine father, blesses', note: 'Direction reused: Vayu is the divine (not physical) father who grants Hanuman’s powers; Kesari is the earthly father.' },
